...
setInterval(function() {
    var trailElements = document.querySelectorAll('body');
    trailElements.forEach(function(trailElement) {
        trailElement.style.backgroundColor = getRandomColor();
    });
}, 500); // Change the interval (in milliseconds) to adjust the speed of color change
